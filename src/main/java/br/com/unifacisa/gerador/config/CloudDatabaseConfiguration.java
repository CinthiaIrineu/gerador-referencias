package br.com.unifacisa.gerador.config;
...
@Configuration
@EnableMongoRepositories("br.com.unifacisa.gerador.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("br.com.unifacisa.gerador.config.dbmigrations");
